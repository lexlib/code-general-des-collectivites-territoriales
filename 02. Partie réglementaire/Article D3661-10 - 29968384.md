...
la métropole de Lyon. Elles sont votées par le conseil de la métropole lors de l'adoption du budget de l'exercice ou des
...
un ensemble d'immobilisations déterminées, acquises ou réalisées par la métropole de Lyon, ou à des subventions d'équipement
versées à des tiers. 
